...
def parse_args():
    ...
    parser.add_argument('-on', '--optimizer_name', help='name of optimizer, add "_lookahead" to implement lookahead on top of optimizer (not recommended for ranger or rangerlars)', type=str, default='rangerlars')
    ...
    parser.add_argument('-eu', '--embedding_unfreeze', help='epoch (index) at which mat2vec embeddings are unfrozen', type=int, default=64)
    parser.add_argument('-lr', '--learning_rate', help='optimizer learning rate', type=float, default=4e-2)
    ...
    parser.add_argument('-su', '--scheduling_unlock', help='epoch (index) at which scheduler starts', type=int, default=46)
